...
$(document).ready(function (){
	...
	$('#submit').click(function submit_func(){
		...
		if(tries<9){
            ...
            $('#history_sidebar').append('<div class="item"><span>Word: </span><spanclass>'+user_word+'</span><br><span>Cows: </span><span>'+cows+' </span><span>Bulls: </span><span>'+bulls+'</span></div>');
			...
			$('#heading').html('Sorry you lost! <br> Page will be reloaded <br> automatically!<br> Play again!');
			$('.word_input').fadeOut();	
			$('#submit').fadeOut();
            setTimeout(function(){
        ...
        if(flag==1) {
         ...
         //alert("Number of times attempted to guess the word is : " + tries);
	});
